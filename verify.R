...
# walidacja danych archiwalnych dla recenzentow:
...
plot(verify(obs = summary_mth_cal$temp_j_obs, pred = summary_mth_cal$temp_j_air2water, frcst.type = "cont",obs.type = "cont"))
plot(verify(obs = summary_mth_val$temp_j_obs, pred = summary_mth_val$temp_j_air2water, frcst.type = "cont",obs.type = "cont"))
